...
public class Board {
  ...
  public Board() throws IOException, InterruptedException, I2CFactory.UnsupportedBusNumberException {
    int busId;
  ...
  public static Board getInstance() throws IOException, InterruptedException, I2CFactory.UnsupportedBusNumberException {
    if(instance == null) {
      instance = new Board();
    }
    return instance;
